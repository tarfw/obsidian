...
Use `tarv10.md` as the consolidated target plan; it distinguishes proposed work
from existing implementation. Earlier plans remain supporting product context.
...
the shared core and domain packages described in `tarv10.md`.
