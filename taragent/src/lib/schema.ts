 ...
 *   (Workspace does NOT own an inbox table; events push to user Personal DBs)
 *
 * Personal DB:
...
// Default export for workspace DB creation
export const SCHEMA_STATEMENTS = WORKSPACE_SCHEMA_STATEMENTS;
