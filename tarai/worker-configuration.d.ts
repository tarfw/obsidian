/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d7863e51570659a147fbbcaa6e611d4b)
// Runtime types generated with workerd@1.20260820.1 2026-08-26 nodejs_compat
interface __BaseEnv_Env {
	TARAI_KV: KVNamespace;
	OKF_STORAGE: R2Bucket;
	CONTROL: D1Database;
	AI: Ai;
	OIDC_ISSUER: "https://accounts.google.com,accounts.google.com";
	OIDC_AUDIENCE: "226183831843-5sjvl1hsv4d04aucnqsqn19u83o4f5ku.apps.googleusercontent.com";
	OIDC_JWKS_URL: "https://www.googleapis.com/oauth2/v3/certs";
	TURSO_ORG: "tarapp";
	TURSO_GROUP_APAC: "default";
	TURSO_GROUP_EU: "default";
	TURSO_GROUP_US: "default";
	ANTHROPIC_API_KEY: string;
	AGENT_WORKFLOW: Workflow<Parameters<import("./src/index").AgentWorkflow['run']>[0]['payload']>;
	PROJECTION_WORKFLOW: Workflow<Parameters<import("./src/index").ProjectionWorkflow['run']>[0]['payload']>;
	ARCHIVE_WORKFLOW: Workflow<Parameters<import("./src/index").ArchiveWorkflow['run']>[0]['payload']>;
	RESTORE_WORKFLOW: Workflow<Parameters<import("./src/index").RestoreWorkflow['run']>[0]['payload']>;
	RENEWAL_WORKFLOW: Workflow<Parameters<import("./src/index").RenewalWorkflow['run']>[0]['payload']>;
	PROVISION_WORKFLOW: Workflow<Parameters<import("./src/index").ProvisionWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OIDC_ISSUER" | "OIDC_AUDIENCE" | "OIDC_JWKS_URL" | "TURSO_ORG" | "TURSO_GROUP_APAC" | "TURSO_GROUP_EU" | "TURSO_GROUP_US" | "ANTHROPIC_API_KEY">> {}
}
