...
export default function BotDirectory({ visible, scope, canInstall, onClose, onChanged, onCreateCustom }: Props) {
...
function BotThumbnail({ botId }: { botId: string }) {
  ...
  return <View style={[styles.botIcon, { backgroundColor: colors.background }]}><TarLogo size={23} color={colors.color} bgColor={colors.background} /></View>;
}
...
const styles = StyleSheet.create({
  ...
  botIcon:{width:36,height:36,borderRadius:11,alignItems:'center',justifyContent:'center',overflow:'hidden'},
