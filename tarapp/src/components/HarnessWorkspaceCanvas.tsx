...
import { ActivityIndicator, Alert, AppState, Pressable, RefreshControl, ScrollView, StyleSheet, Text, TouchableOpacity, View } from 'react-native';
...
export type WorkspaceTab = 'canvas' | 'inbox' | 'records' | 'bots';
