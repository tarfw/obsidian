...
export interface Workspace { readonly id: string; readonly name: string; readonly slug: string; readonly mode: 'personal' | 'work'; readonly databaseName: string; readonly databaseHost: string | null; readonly state: WorkspaceState; readonly ownerName?: string; }
...
export interface FlowRun { readonly id: string; readonly flowId: string; readonly flowVersion: number; readonly occurrence: string; readonly recordId: string | null; readonly state: string; readonly actionId: string | null; readonly context: Record<string, unknown>; readonly version: number; }
