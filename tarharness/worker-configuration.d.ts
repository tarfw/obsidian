/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b57be01d3b65e2ef4e2acae3e0fbc09c)
// Runtime types generated with workerd@1.20260903.1 2026-09-05 nodejs_compat
interface __BaseEnv_Env {
	PRODUCT_CONTENT: R2Bucket;
	SITE_RELEASES: R2Bucket;
	CONTROL: D1Database;
	OUTBOX: Queue;
	AI: Ai;
	...
	TURSO_ORG: "tarfwrk";
	TURSO_GROUP: "default";
	FLOWS: Workflow<Parameters<import("./src/index").FlowWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OIDC_ISSUER" | "OIDC_AUDIENCE" | "OIDC_JWKS_URL" | "TURSO_ORG" | "TURSO_GROUP">> {}
}
